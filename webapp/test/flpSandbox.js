		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#employeedetailentity-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"employeedetailentity-display": {
								"semanticObject": "employeedetailentity",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=employeedetailentity",
									"url": sap.ui.require.toUrl("employeedetailentity")
								}
							}
						}
					}
